...
import 'instructionsDetail.dart';
...
class _InstructionsPageState extends State<InstructionsPage> {
  ...
  _getData(String fixedAssetsNo)async{
      ...
      try{
        ...
        Response response=await dio.get('http://192.168.2.150:20001/api/instructions/fixedAssetsNo?fixedAssetsNo=$fixedAssetsNo');
              ...
              return GestureDetector(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            decoration: BoxDecoration(
                                color: Colors.white,
                                image: DecorationImage(image: AssetImage('images/ic_pdf.png'),fit:BoxFit.cover)
                            ),
                          ),
                          Container(
                            width: 160,
                ...
                onTap: (){
                  ...
                  Navigator.push(context, MaterialPageRoute(
                    builder: (context)=>InstructionsDetailPage(title: _list[index]['name'],id: _list[index]['id'],),
                  ));
                },
              );
