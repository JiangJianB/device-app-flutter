...
class _DailyMainPageState extends State<DailyMaintainPage> {
  ...
  void initState() {
    ...
    if (widget.fixedAssetsNo != null) {
      ...
      _getData(_fixedAssetsNo,0);
    }
  }

  _getData(String fixedAssetsNo,int b) async {
    ...
    try {
      ...
      benchmarkDTOList = data['data']['allTallyDTOList'][b]['tallyCategoryDetailDTOList'][b]['benchmarkDTOList'];
      print(benchmarkDTOList);
      tallyCategoryDetailDTOList = data['data']['allTallyDTOList'][b]['tallyCategoryDetailDTOList'];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                                      ...
                                      children: <Widget>[
                                          ...
                                          child: FlatButton(
                                            onPressed: () {
                                              Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
                                                    builder: (context) => AlltallycountPage(
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Row(
                                                  ...
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: <Widget>[
                                                    _text['tallyAllCount'] == null
                                                        ? Text(
                                                            '0',
                                                            style: TextStyle(color: Colors.pink, fontSize: 20),
                                                          )
                                                        : Text(_text['tallyAllCount'].toString(),
                                                            style: TextStyle(color: Colors.pink, fontSize: 20),
                                                          ),
                                                    SizedBox(width: 10.0),
                                                    Icon(
                                        ...
                                        Container(
                                          child: FlatButton(
                                            onPressed: () {
                                              Navigator.push(context, MaterialPageRoute(
                                                    builder: (context) => NowtallycountPage(
                                                      fixedAssetsNo: _fixedAssetsNo,
                                                      tallyType: _text['tallyType'],
                                                      names: _text['allTallyDTOList'],
                                                      datas: _text,
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Row(
                                                  ...
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: <Widget>[
                                                    _text['nowTallyCount'] == null
                                                        ? Text(
                                                            '0',
                                                            style: TextStyle(color: Colors.pink, fontSize: 20),
                                                          )
                                                        : Text(
                                                            _text['nowTallyCount'].toString(),
                                                            style: TextStyle(color: Colors.pink, fontSize: 20),
                                                          ),
                                                    SizedBox(width: 10.0),
                                                    Icon(
                                        ...
                                        Container(
                                          child: FlatButton(
                                            onPressed: () {
                                              Navigator.push(context, MaterialPageRoute(
                                                    builder: (context) => AlreadytallycountPage(
                                                      fixedAssetsNo: _fixedAssetsNo,
                                                      tallyType: _text['tallyType'],
                                                      names: _text['allTallyDTOList'],
                                                      datas: _text,
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Row(
                                                  ...
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: <Widget>[
                                                    _text['alreadyTallyCount'] == null
                                                        ? Text(
                                                            '0',
                                                            style: TextStyle(color: Colors.pink, fontSize: 20),
                                                          )
                                                        : Text(
                                                            _text['alreadyTallyCount'].toString(),
                                                            style: TextStyle(color: Colors.pink, fontSize: 20),
                                                          ),
                                                    SizedBox(width: 10.0),
                                                    Icon(
                                        ...
                                        Container(
                                          child: FlatButton(
                                            onPressed: () {
                                              Navigator.push(context, MaterialPageRoute(
                                                    builder: (context) => NeedtallycountPage(
                                                      fixedAssetsNo: _fixedAssetsNo,
                                                      tallyType: _text['tallyType'],
                                                      names: _text['allTallyDTOList'],
                                                      datas: _text,
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Row(
                                                  crossAxisAlignment: CrossAxisAlignment.end,
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: <Widget>[_text['needTallyCount'] == null
                                                        ? Text(
                                                            '0',
                                                            style: TextStyle(color: Colors.pink, fontSize: 20),
                                                          )
                                                        : Text(
                                                            _text['needTallyCount'].toString(),
                                                            style: TextStyle(color: Colors.pink, fontSize: 20),
                                                          ),
                                                    SizedBox(width: 10.0),
                                                    Icon(
                                          ...
                                          child: FlatButton(
                                            onPressed: () {
                                              Navigator.push(context,
                                                  MaterialPageRoute(builder: (context) => AbnormaltallycountPage(
                                                      fixedAssetsNo: _fixedAssetsNo,
                                                      tallyType: _text['tallyType'],
                                                      names: _text['allTallyDTOList'],
                                                      datas: _text,
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Row(
                                                  ...
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: <Widget>[
                                                    _text['abnormalTallyCount'] == null
                                                        ? Text(
                                                            '0',
                                                            style: TextStyle(color: Colors.pink, fontSize: 20),
                                                          )
                                                        : Text(
                                                            _text['abnormalTallyCount'].toString(),
                                                            style: TextStyle(color: Colors.pink, fontSize: 20),
                                                          ),
                                                    SizedBox(width: 10.0),
                                                    Icon(
      ...
      bottomNavigationBar: _text['needTallyCount'] == 0
          ? BottomAppBar(
              child: Row(
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => SpotcheckPage(
                                ...
                                tallyCategoryDetailDTOList: tallyCategoryDetailDTOList,
                              ),
                            ));
                      },
                    ),
