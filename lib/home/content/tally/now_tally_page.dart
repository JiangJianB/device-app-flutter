...
class NowtallycountPage extends StatefulWidget {
  final fixedAssetsNo;
  final name;
  final names;
  final datas;
  ...
  @override
  _NowtallycountPageState createState() => _NowtallycountPageState();
}

class _NowtallycountPageState extends State<NowtallycountPage> {
  var _token;
  var _name;
  var _names;
  var _text;
  ...
  void initState() {
    ...
    if (widget.fixedAssetsNo != null) {
      setState(() {
        ...
        _datas = widget.datas.toString();
        debugPrint(_names);
        print(widget.datas['nowTallyCount']);
      });
