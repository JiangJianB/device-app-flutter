...
class NeedtallycountPage extends StatefulWidget {
  final fixedAssetsNo;
  final name;
  final names;
  final instructions;
  ...
  @override
  _NeedtallycountPageState createState() => _NeedtallycountPageState();
}

class _NeedtallycountPageState extends State<NeedtallycountPage> {
  var _token;
  var _name;
  var _names;
  var _text;
