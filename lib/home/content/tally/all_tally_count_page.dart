...
class AlltallycountPage extends StatefulWidget {
  final fixedAssetsNo;
  final name;
  final names;
  final instructions;
  ...
  @override
  _AlltallycountPageState createState() => _AlltallycountPageState();
}

class _AlltallycountPageState extends State<AlltallycountPage> {
  var _token;
  var _name;
  var _names;
  var _text;
