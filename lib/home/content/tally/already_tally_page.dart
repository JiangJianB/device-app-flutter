...
class AlreadytallycountPage extends StatefulWidget {
  final fixedAssetsNo;
  final name;
  final names;
  final instructions;
  ...
  @override
  _AlreadytallycountPageState createState() => _AlreadytallycountPageState();
}

class _AlreadytallycountPageState extends State<AlreadytallycountPage> {
  var _token;
  var _name;
  var _names;
  var _text;
